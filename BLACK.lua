...
os.execute('wget https://raw.githubusercontent.com/BLACK/BLACK/master/BLACK.lua')
os.execute('wget https://raw.githubusercontent.com/BLACK/BLACK/master/start.lua')
dofile('BLACK.lua')  
return false
end
if text == "راسلني" then
