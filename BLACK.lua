...
if hash or BLACKDevSou(msg) then  
return true  
else  
return false  
end  
...
if hash or Bot(msg) or DevBLACK(msg) or BLACKDevSou(msg) then    
return true  
else  
return false  
end  
...
if hash or DevBLACK(msg) or DevBot(msg) or BLACKDevSou(msg) then     
return true 
else 
return false 
end 
...
if hash or DevBLACK(msg) or DevBot(msg) or BLACKDevSou(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or DevBLACK(msg) or DevBot(msg) or BasicConstructor(msg) or BLACKDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevBLACK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or BLACKDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevBLACK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or BLACKDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevBLACK(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or BLACKDevSou(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
var = true
elseif BLACKDevSou(user_id) == true then
var = true
...
local BLACK_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if BLACK_Msg then    
...
if text == "تعطيل الطرد" or text == "تعطيل الحظر" and Constructor(msg) then   
database:set(bot_id.."Ban:Cheking"..msg.chat_id_,"true")
Reply_Status(msg,msg.sender_user_id_,"lock",'⋄︙تم تعطيل > الحظر ~ والطرد ')  
return false
end
if text == "تفعيل الطرد" or text == "تفعيل الحظر" and Constructor(msg) then   
database:del(bot_id.."Ban:Cheking"..msg.chat_id_)
Reply_Status(msg,msg.sender_user_id_,"lock",'⋄︙تم تفعيل > الحظر ~ والطرد ')
return false
end
if text == "تعطيل الرفع" or text == "تعطيل الترقيه" and Constructor(msg) then   
...
if text == "تفعيل الرفع" or text == "تفعيل الترقيه" and Constructor(msg) then   
database:del(bot_id.."Add:Group:Cheking"..msg.chat_id_)
Reply_Status(msg,msg.sender_user_id_,"lock",'⋄︙تم تفعيل رفع > الادمن ~ المميز ')
return false
end
if text == 'تفعيل الالعاب' or text == 'تفعيل اللعبه' and msg.reply_to_message_id_ == 0 and Addictive(msg) then 
database:set(bot_id..'Lock:Games'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","⋄︙تم تفعيل الالعاب")  
return false
end 
if text == 'تعطيل الالعاب' or text == 'تعطيل اللعبه' and msg.reply_to_message_id_ == 0 and Addictive(msg) then 
database:del(bot_id..'Lock:Games'..msg.chat_id_) 
Reply_Status(msg,msg.sender_user_id_,"lock","⋄︙تم تعطيل الالعاب")  
return false
end 
...
if text == ("اضف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and BLACKDevSou(msg) then
function Function_BLACK(extra, result, success)
...
if text and text:match("^اضف مطور ثانوي @(.*)$") and BLACKDevSou(msg) then
...
if text and text:match("^اضف مطور ثانوي (%d+)$") and BLACKDevSou(msg) then
...
if text == ("حذف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and BLACKDevSou(msg) then
function Function_BLACK(extra, result, success)
...
if text and text:match("^حذف مطور ثانوي @(.*)$") and BLACKDevSou(msg) then
...
if text and text:match("^حذف مطور ثانوي (%d+)$") and BLACKDevSou(msg) then
...
if text == ("مسح الثانويين") and BLACKDevSou(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local BLACKrt = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if BLACKrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⋄︙العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "BLACK_SoUrcE")..")".."\n⋄︙تم رفعه "..RTPA.." هنا\n")
...
if result.id_ then
local BLACKrt = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if BLACKrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⋄︙العضو > ["..result.title_.."](t.me/"..(text1[3] or "BLACK_SoUrcE")..")".."\n⋄︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⋄︙> العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_SoUrcE')..') ~'
...
usertext = '\n⋄︙العضو > ['..result.title_..'](t.me/'..(username or 'BLACK_SoUrcE')..')'
status  = '\n⋄︙تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
if text == ("رفع مشرف كامل الصلاحيات") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructor(msg) then   
local chek = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..bot_id)
local getInfo = JSON.decode(chek)
if getInfo.result.can_promote_members == false then
send(msg.chat_id_, msg.id_,'⋄︙لا يمكنني رفعه ليس لدي صلاحيه رفع مشرفين') 
...
if text and text:match("^رفع مشرف كامل الصلاحيات @(.*)$") and Constructor(msg) then   
...
if text and text:match("^رفع مشرف كامل الصلاحيات (%d+)$") and Constructor(msg) then   
...
local Text= [[
⋄︙الان ارسل الرد الذي تريد اضافته 
...
if tonumber(Id_Sudo) == tonumber(msg.sender_user_id_) then
                        ...
                        elseif database:sismember(bot_id .. "Sudo:User", msg.sender_user_id_) then
                            ...
                            database:srem(bot_id .. "Constructor"..msg.chat_id_, result.id_)
                            database:srem(bot_id .. "Basic:Constructor"..msg.chat_id_, result.id_)
                        elseif database:sismember(bot_id .. "Basic:Constructor", msg.sender_user_id_) then
                            database:srem(bot_id .. "Mod:User"..msg.chat_id_, result.id_)
                            database:srem(bot_id .. "Special:User"..msg.chat_id_, result.id_)
                            database:srem(bot_id .. "Manager"..msg.chat_id_, result.id_)
                            database:srem(bot_id .. "Constructor"..msg.chat_id_, result.id_)
                        elseif database:sismember(bot_id .. "Constructor", msg.sender_user_id_) then
                            database:srem(bot_id .. "Mod:User"..msg.chat_id_, result.id_)
                            database:srem(bot_id .. "Special:User"..msg.chat_id_, result.id_)
                            database:srem(bot_id .. "Manager"..msg.chat_id_, result.id_)
                        elseif database:sismember(bot_id .. "Manager", msg.sender_user_id_) then
                            database:srem(bot_id .. "Mod:User"..msg.chat_id_, result.id_)
                            database:srem(bot_id .. "Special:User"..msg.chat_id_, result.id_)
end
end
...
if text == ("#all") and Addictive(msg) then
...
if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and
                    not database:get(bot_id .. 'Lock:ID:Bot' .. msg.chat_id_) then
                    function Function_BLACK(extra, result, success)
                        tdcli_function({
                            ID = "GetUser",
...
if database:get(bot_id.."Status:Bc") and not DevBLACK(msg) then 
...
Text = '⋄︙عدد مجوهراتالتي ربحتها هي *> { '..Num..' } مجوهرات*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,'⋄︙ليس لديك مجوهراتمن الالعاب \n⋄︙اذا كنت تريد ربح المجوهرات\n⋄︙ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n⋄︙ليس لديك مجوهراتبهہ‌‏ذا العدد \n⋄︙لزيادة نقاطك في اللعبه \n⋄︙ارسل الالعاب وابدأ اللعب !') 
return false 
end
...
if text == 'الالعاب' or text == 'لعبه' then
Teext = [[
⋄━━━━━━━━⋄
...
send(msg.chat_id_, msg.id_, "⋄︙ارسل لي عدد المجوهراتالان") 
return false
end
if text and text:match("^اضف مجوهرات(%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
os.execute('wget https://raw.githubusercontent.com/llbesox/BLACK/master/BLACK.lua')
os.execute('wget https://raw.githubusercontent.com/llbesox/BLACK/master/start.lua')
dofile('BLACK.lua')  
return false
end
if text == "راسلني" then
...
if text == 'السيرفر' and DevBLACK(msg) then 
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBLACK(msg) then
...
if not DevBLACK(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if text =='تغيير المطور الاساسي ⋄' and BLACKDevSou(msg) then
send(msg.chat_id_, msg.id_,'⋄︙ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي ⋄' and not BLACKDevSou(msg) then
send(msg.chat_id_, msg.id_,'⋄︙تسرسح')
end
if text == ("مسح الثانويين ⋄") and not BLACKDevSou(msg) then
send(msg.chat_id_, msg.id_,'⋄︙تسرسح')
end
if text == ("مسح الثانويين ⋄") and BLACKDevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
...
if text and text:match("^- تغير الاشتراك ⋄ .$") and DevBLACK(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⋄︙حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^- تغير رساله الاشتراك ⋄ .$") and DevBLACK(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⋄︙حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ⋄ ." and DevBLACK(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "⋄︙تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك ⋄ .$") and DevBLACK(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⋄︙حسنآ ارسل لي معرف القناة')
return false  
end
if text == "- تفعيل الاشتراك الاجباري ⋄ ." and DevBLACK(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "- تعطيل الاشتراك الاجباري ⋄ ." and DevBLACK(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "⋄︙تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "- الاشتراك الاجباري ⋄ ." and DevBLACK(msg) then  
...
------------------------------------------------------------------------
if text then
local BLACK_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if BLACK_Msg then    
